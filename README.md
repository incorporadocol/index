...
<head>
	<meta charset="UTF-8">
	<meta id="meta_referrer" name="referrer">
	<META NAME="description" content="Incorporado. Información de la empresa y productos.">
<link rel="stylesheet" type"text/css" href="style.css">
<style>
@import url('https://fonts.googleapis.com/css2?family=Baloo+Paaji+2&display=swap');
body {background-color:black;width:100%;height:100%;color:#08210f;font-family: 'Baloo Paaji 2';text-align:center;
		margin: 0 0 0 0; padding: 0 0 0 0;}
p {color:black;font-size:14px;line-height:1.5;}
a {color:#0a4d43;font-size:13px;}
li {color:black;font-size:14px;}
ul {font-size:14px;}
ol {font-size:14px;display:inline-block;padding:0 50px 0 35px;}
h1 {color:#0a4d43;font-size:25px;text-align:center;padding:20px;}
h2 {color:#0a4d43;font-size:19px;text-align:right;padding:50px 0 20px 0}
h3 {color:#0a4d43;font-size:18px;}
h4 {color:#0a4d43;font-size:17px;}
h5 {color:#fbfefb;font-size:12px;}
main {column-count:3;text-align:center;}
table {padding:10px;}
td {color:#727268;padding:5px;}
th {color:#727268;padding:5px;}
button {text-decoration:none;margin: 15px 0 15px 0;padding:8px;font-weight:15px;font-size:14px;font-family: 'Baloo Paaji 2';color:#fcfffd;background-color:#8aac46;border-radius:3px;}

.boxA {display:inline-block;padding-top:80px;}
.boxB {display:inline-block;}
.boxC {display:inline-block;}
.boxD {margin:0 60px 0 60px;padding:30px;}
.boxE {display:inline-block;}
.egt {display:inline-block;font-size:14px;}
.boton_personalizado{margin-left:10px;}

#header {display:block;background-color:white}
#header-title {position:absolute;clear:both;padding:20px;}
#header-nav {float:right;padding:0 40px 0 0;}
#headcent {background-color:#03211f;display:block;text-align:right;}
#headcent a {color:#fcfffd;} #headcent strong {color:white}
#content {background-color:#f2f0e8;}
#price {background-color:white;padding:90px 50px 0 0;text-align:center;}
#stock {background-color:white;padding:20px 40px 40px 0;}
#prompt1 {display:inline-table;text-align:right;padding:0 20px 20px 20px;border-radius:20px 0;float:left;}
#prompt2 {display:inline-table;text-align:justify;padding:0 20px 20px 20px;border-radius:0 20px;float:right;}
#blog {text-align:justify}
#post {padding:0 50px 0 20px;}
#post-author img {width80px;height:80px;vertical-margin:middle;} #post-author span {margin-left:10px;color:#073723;font-size:12px;visibility:hidden;} 
#post-date {float:right;margin-left:16px;color:#073723;font-size:12px;} 
#form {background-color:#cce5e4;padding: 20px 0 60px 0;text-align:center;}
#submit {text-decoration:none;margin: 8px 0 8px 0;padding:8px;font-weight:15px;font-size:14px;font-family: 'Baloo Paaji 2';color:#fcfffd;background-color:#3dbdc8;border-radius:3px;}
#plat {background-color:#f2f0e8;padding:30px;}
#plat a {color:#010e06;} #plat li {color:#010e06;text-align:justify;padding:20px;} #plat strong {font-size:14px;}
#main {background-color:#e4f4ea;text-align:center;}
#pics {padding:30px 40px 0 40px;display:inline-block;margin:5px;visibility:hidden;}
#footer {background-color:black;text-align:center;padding:10px 10px 10px 10px;clear:both;}
...
<td><div><h1>Cerveza Artesanal</h1>
...
<div id="form"><div class="boxE" id="box6">
...
<main>
	...
	<br>
	<a class="boton_personalizado" href="https://drive.google.com/open?id=1QJubuRhzFg0QtmAH9TrlwjOJlKDlW1-9JCvB8NPuJEw" target="_blank">Entrenamiento</a>
	<br>
